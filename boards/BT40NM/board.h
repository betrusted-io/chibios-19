 ...
 */
#define BOARD_BT40NM
#define BOARD_NAME                  "Betrusted 40nm characterization STM32H743VIT6"
...
#define LINE_LED0                   PAL_LINE(GPIOA, 5U)
 ...
 * PA4  - LED1                      (output pushpull)
 * PA5  - LED0                      (output pushpull)
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_LOW(GPIOA_WAKEUP) |       \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_ZIO_D33) |       \
                                     ...
                                     PIN_OSPEED_LOW(GPIOB_USART1_TX) |          \
                                     PIN_OSPEED_LOW(GPIOB_USART1_RX))
